      ...
      <div className=' flex flex-col items-center gap-16'>
        ...
        <form className=' flex flex-col gap-[40px] items-start'>
            <div className=' flex flex-col gap-3 '>
                ...
                <input className=' border-[1px] rounded-[10px] outline-none w-[30vw]  sm:w-[70vw] h-[6vh] pl-11 active:border-[#F178B6] duration-150 ' type="text" placeholder='Enter Amount in Number' />
            </div>
            <div className=' flex flex-col gap-3 '>
                <label htmlFor="amount">Email </label>
                <input className='border-[1px] rounded-[10px] outline-none w-[30vw] sm:w-[70vw] h-[6vh] pl-11 active:border-[#F178B6]  duration-150' type="email" placeholder='example@yahoo.com' />
            </div>
