...
function Forgetpass() {
  return (
    <div className=' img font-worksans bg-red-700 flex items-center justify-center gap-[200px] h-[100vh] w-[100%] sm:flex-col sm:gap-[80px] lg:overflow-x-hidden sm:overflow-x-hidden md:overflow-x-hidden'>
      <div className='bg-[#5d5fef60] flex items-center justify-center  absolute left-0 top-0 right-0 bottom-0 sm:flex-col md:flex-col sm:gap-[80px] gap-[200px]'>
