...
function Login() {
  ...
  return (
      <div className='back-img flex items-center font-worksans h-[100vh] w-[100%] justify-center   md:flex-col overflow-y-hidden '>
        <div className='  font-worksans flex items-center justify-center lg:gap-[170px] sm:gap-[80px] md:flex-col  sm:flex-col lg:mb-[7%] '>
        <div className=' text-center text-[20px] font-light'>
            <p className=' text-gray-200'>
           <span className=' text-white text-[30px] font-bold'> Welcome Back!</span> <br/>
        ...
        <div className=' bg-[#a5a6f69c] flex flex-col justify-center gap-[20px] p-[50px] rounded-[10px] md:p-[15px] sm:p-[15px]'>
